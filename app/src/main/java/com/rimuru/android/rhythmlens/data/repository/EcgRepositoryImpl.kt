...
import com.rimuru.android.rhythmlens.data.repository.mapper.DigitizedEcgJsonMapper
...
class EcgRepositoryImpl @Inject constructor(
    ...
    private val digitizedEcgJsonMapper: DigitizedEcgJsonMapper
) : EcgRepository {
    ...
    private fun EcgRecordEntity.toDomain(): EcgRecord {
        return EcgRecord(
            ...
            digitizedSignal = digitizedEcgJsonMapper.fromJson(digitizedSignalJson),
            heartRate = heartRate,
    ...
    private fun EcgRecord.toEntity(): EcgRecordEntity {
        return EcgRecordEntity(
            ...
            recordedAt = recordedAt,
            originalImageUrl = originalImageUrl,
            digitizedSignalJson = digitizedEcgJsonMapper.toJson(digitizedSignal),
            heartRate = heartRate,
            status = status.name,
            processingMessage = processingMessage,
            errorMessage = errorMessage,
